...
const Rincian = (props) => {
  ...
  //     });
  //   }
  //   window.onbeforeprint = hideButtons;
  //   window.onafterprint = () => {
  //     buttonsRef.current.forEach(button => {
          ...
          <div className="container mx-auto my-4" id="print-content">
            ...
            >
              Cek Saldo
                ...
                <div>
                  <button ref={addButton} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="large-modal">
                    Cek saldo
                  </button>
                  &nbsp;
                  <Link ref={addButton}
        ...
        <div className="grid-cols-1 grid gap-4">
          <div>
            <form onSubmit={handleSubmitBulan}>
              ...
              <input type="month" id="month" onChange={(bulan) => setBulan(bulan.target.value)} />
              <button type="submit" className="bg-sky-500 text-white p-2 mt-3 rounded-md">Cek saldo</button>
            </form>
          </div>
          <div>
            ...
            {/* <Input type="year" className="w-full" />
                   */}
            <Link className="bg-sky-500 text-white p-2 mt-3 rounded-md">Cek saldo</Link>
          </div>
        </div>
